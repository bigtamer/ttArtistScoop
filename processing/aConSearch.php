	...
	<div id="contract">
				<ul>
					<li>
						...
						<span style="color:#670000">Offered by:</span> <?php echo $srow['firstName'];?> <?php echo $srow['lastName'];?> 
						<span style="color:#670000">Drafted :</span> <?php echo $srow['dateDrafted'];?> 
						...
						<a href="processing/acceptContract.php?c=<?php echo $srow['contractId'];?>&d=<?php echo $srow['drafter'];?>"><img src="images/confirm.png" width="25px" height="20px"/></a>
						<?php } else echo $srow["dateConfirmed"]." &nbsp <a href ='pdf/Contract/Contract.php?c=".$srow['contractId']."' target='_blank'>VIEW</a>"; ?>
					</li>
				</ul>
			</div>
			<!--clause list-->
							...
							<?php 
								...
								<div class="comments">
									...
									<ol  id="update<?php echo $row1['clauseId'];?>" class="timeline">
											...
											$result3 = mysql_query("SELECT * FROM tblclcomment c, tbluser u WHERE u.userid = c.commenter AND c.clause='$clid'");
									...
									<div style="margin-left:220px">
										...
										<textarea name="comment" id="comment<?php echo $row1["clauseId"]?>"></textarea><br />

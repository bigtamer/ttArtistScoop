...
{						
	...
	*/
	...
	$targetpage = "artistContracts.php?";
...
<head>
	...
	xmlhttp.open("GET","processing/aConSearch.php?c="+str,true);
	xmlhttp.send();
	}
	</script>
			...
			<div id="contract">
				<ul>
					<li>
						...
						<span style="color:#670000">Offered by:</span> <?php echo $row['firstName'];?> <?php echo $row['lastName'];?> 
